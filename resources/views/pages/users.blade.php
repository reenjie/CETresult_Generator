...
@section('content')
    <div class="container">
        ...
        <div class="mycard">
            <button class="btn btn-primary  px-3" data-toggle="modal" data-target="#addaccount">Add <i
                        ...
                        @foreach ($user as $key => $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <div class="btn-group">
                                            <button class="btn btn-light btnedit text-success"
                                                data-fname="{{ $item->fname }}" data-lname="{{ $item->lname }}"
                                                data-email="{{ $item->email }}" data-id="{{ $item->id }}"
                                                data-toggle="modal" data-target="#editaccount"><i
                                                    class="fas fa-pen"></i></button>
                                            <button class="btn btn-light text-danger btndelete"
                                                data-id="{{ $item->id }}"><i class="fas fa-trash-can"></i></button>
                                        </div>
                                    @endif
                                </td>
                            </tr>
