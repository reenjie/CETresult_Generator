            ...
            <div class="container-fluid">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-10 p-5 bg-light">
                        <button class="btn btn-danger btn-sm px-4" onclick="window.location.href='/' "><i class="fas fa-arrow-left"></i> Back</button>
                        <br>
                        <h2>List of Takers
                            <br> <span style="font-size:20px;font-weight:normal">YEAR {{$upyear}}</span>
